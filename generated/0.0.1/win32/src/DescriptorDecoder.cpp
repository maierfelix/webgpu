...
static std::unordered_map<std::string, uint32_t> GPUSTypeMap = {
  ...
  { "sampler-descriptor-dummy-anisotropic-filtering", 5 },
  { "render-pipeline-descriptor-dummy-extension", 6 },
};
...
namespace DescriptorDecoder {
  ...
  void DestroyGPUBindGroupEntry(WGPUBindGroupEntry descriptor) {
  };
  ...
  void DestroyGPUBindGroupDescriptor(WGPUBindGroupDescriptor descriptor) {
    ...
    if (descriptor.bindingCount > 0) {
      for (unsigned int ii = 0; ii < descriptor.bindingCount; ++ii) {
        DestroyGPUBindGroupEntry(descriptor.bindings[ii]);
      };
    }
    if (descriptor.bindings) {
      free((void*) const_cast<WGPUBindGroupEntry*>(descriptor.bindings));
    }
  };
  
  void DestroyGPUBindGroupLayoutEntry(WGPUBindGroupLayoutEntry descriptor) {
  };
  ...
  void DestroyGPUBindGroupLayoutDescriptor(WGPUBindGroupLayoutDescriptor descriptor) {
    ...
    if (descriptor.bindingCount > 0) {
      for (unsigned int ii = 0; ii < descriptor.bindingCount; ++ii) {
        DestroyGPUBindGroupLayoutEntry(descriptor.bindings[ii]);
      };
    }
    if (descriptor.bindings) {
      free((void*) const_cast<WGPUBindGroupLayoutEntry*>(descriptor.bindings));
    }
  };
  ...
  void DestroyGPURenderPipelineDescriptorDummyExtension(WGPURenderPipelineDescriptorDummyExtension descriptor) {
    DestroyGPUProgrammableStageDescriptor(descriptor.dummyStage);
  };
  ...
  void DestroyGPUSamplerDescriptorDummyAnisotropicFiltering(WGPUSamplerDescriptorDummyAnisotropicFiltering descriptor) {
  };
  ...
  WGPUBindGroupEntry DecodeGPUBindGroupEntry(GPUDevice* device, const Napi::Value& value) {
    WGPUBindGroupEntry descriptor;
    // reset descriptor
  ...
  descriptor.accelerationContainer = nullptr;
    ...
    if (!(obj.Get("binding").IsNumber())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUBindGroupEntry'.'binding'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    if (!(obj.Get("binding").IsNumber())) {
    ...
    if (obj.Has("buffer")) {
      if (!(obj.Get("buffer").IsObject()) || !(obj.Get("buffer").As<Napi::Object>().InstanceOf(GPUBuffer::constructor.Value()))) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'GPUBuffer' for 'GPUBindGroupEntry'.'buffer'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("offset")) {
      if (!(obj.Get("offset").IsNumber())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUBindGroupEntry'.'offset'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
      if (!(obj.Get("offset").IsNumber())) {
    ...
    if (!(obj.Get("size").IsNumber())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUBindGroupEntry'.'size'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    if (!(obj.Get("size").IsNumber())) {
    ...
    if (obj.Has("sampler")) {
      if (!(obj.Get("sampler").IsObject()) || !(obj.Get("sampler").As<Napi::Object>().InstanceOf(GPUSampler::constructor.Value()))) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'GPUSampler' for 'GPUBindGroupEntry'.'sampler'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("textureView")) {
      if (!(obj.Get("textureView").IsObject()) || !(obj.Get("textureView").As<Napi::Object>().InstanceOf(GPUTextureView::constructor.Value()))) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'GPUTextureView' for 'GPUBindGroupEntry'.'textureView'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("accelerationContainer")) {
      if (!(obj.Get("accelerationContainer").IsObject()) || !(obj.Get("accelerationContainer").As<Napi::Object>().InstanceOf(GPURayTracingAccelerationContainer::constructor.Value()))) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'GPURayTracingAccelerationContainer' for 'GPUBindGroupEntry'.'accelerationContainer'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    {
      {
        ...
        uint32_t length = array.Length();
        WGPUBindGroupEntry* data = (WGPUBindGroupEntry*) malloc(length * sizeof(WGPUBindGroupEntry));
        for (unsigned int ii = 0; ii < length; ++ii) {
      if (!(array.Get(ii).IsObject())) {
            Napi::String type = Napi::String::New(value.Env(), "Type");
      ...
      for (unsigned int ii = 0; ii < length; ++ii) {
        Napi::Object item = array.Get(ii).As<Napi::Object>();
        WGPUBindGroupEntry $bindings = DecodeGPUBindGroupEntry(device, item.As<Napi::Value>());
        memcpy(
          reinterpret_cast<void*>(&data[ii]),
  ...
  WGPUBindGroupLayoutEntry DecodeGPUBindGroupLayoutEntry(GPUDevice* device, const Napi::Value& value) {
    WGPUBindGroupLayoutEntry descriptor;
    // reset descriptor
  ...
  descriptor.storageTextureFormat = static_cast<WGPUTextureFormat>(0);
    // fill descriptor
    Napi::Object obj = value.As<Napi::Object>();
    if (!(obj.Get("binding").IsNumber())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUBindGroupLayoutEntry'.'binding'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    if (!(obj.Get("binding").IsNumber())) {
    ...
    if (!(obj.Get("visibility").IsNumber())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUBindGroupLayoutEntry'.'visibility'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    ...
    if (!(obj.Get("type").IsString())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'String' for 'GPUBindGroupLayoutEntry'.'type'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    ...
    if (obj.Has("hasDynamicOffset")) {
      if (!(obj.Get("hasDynamicOffset").IsBoolean())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'Boolean' for 'GPUBindGroupLayoutEntry'.'hasDynamicOffset'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("multisampled")) {
      if (!(obj.Get("multisampled").IsBoolean())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'Boolean' for 'GPUBindGroupLayoutEntry'.'multisampled'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("textureDimension")) {
      if (!(obj.Get("textureDimension").IsString())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'String' for 'GPUBindGroupLayoutEntry'.'textureDimension'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("textureComponentType")) {
      if (!(obj.Get("textureComponentType").IsString())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'String' for 'GPUBindGroupLayoutEntry'.'textureComponentType'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
    ...
    if (obj.Has("storageTextureFormat")) {
      if (!(obj.Get("storageTextureFormat").IsString())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'String' for 'GPUBindGroupLayoutEntry'.'storageTextureFormat'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
      descriptor.storageTextureFormat = static_cast<WGPUTextureFormat>(GPUTextureFormat(obj.Get("storageTextureFormat").As<Napi::String>().Utf8Value()));
    }
    return descriptor;
  };
    ...
    {
      {
        Napi::Array array = obj.Get("bindings").As<Napi::Array>();
        uint32_t length = array.Length();
        WGPUBindGroupLayoutEntry* data = (WGPUBindGroupLayoutEntry*) malloc(length * sizeof(WGPUBindGroupLayoutEntry));
        for (unsigned int ii = 0; ii < length; ++ii) {
      if (!(array.Get(ii).IsObject())) {
            Napi::String type = Napi::String::New(value.Env(), "Type");
      ...
      for (unsigned int ii = 0; ii < length; ++ii) {
        Napi::Object item = array.Get(ii).As<Napi::Object>();
        WGPUBindGroupLayoutEntry $bindings = DecodeGPUBindGroupLayoutEntry(device, item.As<Napi::Value>());
        memcpy(
          reinterpret_cast<void*>(&data[ii]),
          reinterpret_cast<void*>(&$bindings),
  ...
  descriptor.rayTracing = false;
    ...
    if (obj.Has("rayTracing")) {
      if (!(obj.Get("rayTracing").IsBoolean())) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'Boolean' for 'GPUDeviceProperties'.'rayTracing'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
      descriptor.rayTracing = obj.Get("rayTracing").As<Napi::Boolean>().Value();
    }
    return descriptor;
  };
  ...
  WGPURenderPipelineDescriptorDummyExtension DecodeGPURenderPipelineDescriptorDummyExtension(GPUDevice* device, const Napi::Value& value) {
    WGPURenderPipelineDescriptorDummyExtension descriptor;
    // reset descriptor
    // fill descriptor
    Napi::Object obj = value.As<Napi::Object>();
    if (!(obj.Get("dummyStage").IsObject())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Object' for 'GPURenderPipelineDescriptorDummyExtension'.'dummyStage'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
      descriptor.dummyStage.nextInChain = nullptr;
      descriptor.dummyStage.module = nullptr;
      descriptor.dummyStage.entryPoint = nullptr;
      Napi::Object $dummyStage = obj.Get("dummyStage").As<Napi::Object>();
      if (!($dummyStage.Get("module").IsObject()) || !($dummyStage.Get("module").As<Napi::Object>().InstanceOf(GPUShaderModule::constructor.Value()))) {
        Napi::String type = Napi::String::New(value.Env(), "Type");
        Napi::String message = Napi::String::New(value.Env(), "Expected 'GPUShaderModule' for 'GPUProgrammableStageDescriptor'.'module'");
        device->throwCallbackError(type, message);
        return descriptor;
      }
      descriptor.dummyStage.module = Napi::ObjectWrap<GPUShaderModule>::Unwrap($dummyStage.Get("module").As<Napi::Object>())->instance;
      {
        if (!($dummyStage.Get("entryPoint").IsString())) {
          Napi::String type = Napi::String::New(value.Env(), "Type");
          Napi::String message = Napi::String::New(value.Env(), "Expected 'String' for 'GPUProgrammableStageDescriptor'.'entryPoint'");
          device->throwCallbackError(type, message);
          return descriptor;
        }
        descriptor.dummyStage.entryPoint = getNAPIStringCopy($dummyStage.Get("entryPoint"));
      }
    return descriptor;
  };
  ...
  WGPUSamplerDescriptorDummyAnisotropicFiltering DecodeGPUSamplerDescriptorDummyAnisotropicFiltering(GPUDevice* device, const Napi::Value& value) {
    WGPUSamplerDescriptorDummyAnisotropicFiltering descriptor;
    // reset descriptor
    // fill descriptor
    Napi::Object obj = value.As<Napi::Object>();
    if (!(obj.Get("maxAnisotropy").IsNumber())) {
      Napi::String type = Napi::String::New(value.Env(), "Type");
      Napi::String message = Napi::String::New(value.Env(), "Expected 'Number' for 'GPUSamplerDescriptorDummyAnisotropicFiltering'.'maxAnisotropy'");
      device->throwCallbackError(type, message);
      return descriptor;
    }
    if (!(obj.Get("maxAnisotropy").IsNumber())) {
    ...
    descriptor.maxAnisotropy = obj.Get("maxAnisotropy").As<Napi::Number>().FloatValue();
    return descriptor;
  };
  ...
  GPUBindGroupEntry::GPUBindGroupEntry(GPUDevice* device, const Napi::Value& value) {
    // reset descriptor
  descriptor.buffer = nullptr;
  descriptor.offset = 0;
  descriptor.sampler = nullptr;
  ...
  GPUBindGroupEntry::~GPUBindGroupEntry() {
    DestroyGPUBindGroupEntry(descriptor);
  };
  ...
  GPUBindGroupLayoutEntry::GPUBindGroupLayoutEntry(GPUDevice* device, const Napi::Value& value) {
    // reset descriptor
  descriptor.hasDynamicOffset = false;
  descriptor.multisampled = false;
  descriptor.textureDimension = static_cast<WGPUTextureViewDimension>(0);
  ...
  GPUBindGroupLayoutEntry::~GPUBindGroupLayoutEntry() {
    DestroyGPUBindGroupLayoutEntry(descriptor);
  };
  ...
  GPURenderPipelineDescriptorDummyExtension::GPURenderPipelineDescriptorDummyExtension(GPUDevice* device, const Napi::Value& value) {
    // reset descriptor
    // fill descriptor
    Napi::Object obj = value.As<Napi::Object>();
    if (!(obj.Get("dummyStage").IsObject())) {
  ...
  GPURenderPipelineDescriptorDummyExtension::~GPURenderPipelineDescriptorDummyExtension() {
    DestroyGPURenderPipelineDescriptorDummyExtension(descriptor);
  };
  ...
  GPUSamplerDescriptorDummyAnisotropicFiltering::GPUSamplerDescriptorDummyAnisotropicFiltering(GPUDevice* device, const Napi::Value& value) {
    // reset descriptor
    // fill descriptor
    Napi::Object obj = value.As<Napi::Object>();
    if (!(obj.Get("maxAnisotropy").IsNumber())) {
  ...
  GPUSamplerDescriptorDummyAnisotropicFiltering::~GPUSamplerDescriptorDummyAnisotropicFiltering() {
    DestroyGPUSamplerDescriptorDummyAnisotropicFiltering(descriptor);
  };
