...
namespace DescriptorDecoder {
  ...
  class GPUBindGroupEntry {
    public:
      GPUBindGroupEntry(GPUDevice* device, const Napi::Value& value);
      ~GPUBindGroupEntry();
      WGPUBindGroupEntry* operator &() { return &descriptor; };
    private:
  ...
  class GPUBindGroupLayoutEntry {
    public:
      GPUBindGroupLayoutEntry(GPUDevice* device, const Napi::Value& value);
      ~GPUBindGroupLayoutEntry();
      WGPUBindGroupLayoutEntry* operator &() { return &descriptor; };
    private:
  ...
  class GPURenderPipelineDescriptorDummyExtension {
    public:
      GPURenderPipelineDescriptorDummyExtension(GPUDevice* device, const Napi::Value& value);
      ~GPURenderPipelineDescriptorDummyExtension();
      WGPURenderPipelineDescriptorDummyExtension* operator &() { return &descriptor; };
    private:
  ...
  class GPUSamplerDescriptorDummyAnisotropicFiltering {
    public:
      GPUSamplerDescriptorDummyAnisotropicFiltering(GPUDevice* device, const Napi::Value& value);
      ~GPUSamplerDescriptorDummyAnisotropicFiltering();
      WGPUSamplerDescriptorDummyAnisotropicFiltering* operator &() { return &descriptor; };
    private:
